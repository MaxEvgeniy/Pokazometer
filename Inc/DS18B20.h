...
#define ONEWIRE_CONVERT_TEMPERATURE 0x44 // Команда начала измерения температуры
...
#define MAXDEVICES_ON_THE_BUS 10  // maximum planned number of devices on the bus
#endif
